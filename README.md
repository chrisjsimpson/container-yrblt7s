...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yrblt7s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yrblt7s.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-yrblt7s.git
cd container-yrblt7s
```
...
```
docker attach container-yrblt7s
```
